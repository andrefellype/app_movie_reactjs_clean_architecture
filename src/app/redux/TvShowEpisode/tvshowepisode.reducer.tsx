import { TV_SHOW_EPISODE_LIST_FILTER_REDUCER, TV_SHOW_EPISODE_LIST_REDUCER, TV_SHOW_EPISODE_SINGLE_REDUCER } from "../../core/consts"

const tvshowepisode = function (state: { episode: null, episodes: [], episodesFilter: [] }, action) {
    switch (action.type) {
