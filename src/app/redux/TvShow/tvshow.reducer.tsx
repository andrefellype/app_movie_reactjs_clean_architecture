import { TV_SHOW_LIST_FILTER_REDUCER, TV_SHOW_LIST_REDUCER, TV_SHOW_SINGLE_REDUCER } from "../../core/consts"

const tvshow = function (state: { tvShow: null, tvShows: [], tvShowsFilter: [] }, action) {
    switch (action.type) {
