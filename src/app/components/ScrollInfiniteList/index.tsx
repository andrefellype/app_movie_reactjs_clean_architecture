...
const ScrollInfiniteList: React.FC<{ isShowScroll: boolean, updateScroll: () => void, children }> = function ({ isShowScroll, updateScroll, children }) {
    ...
    return (
        <React.Fragment>
            {children}
            <CardActions>
                {(isShowScroll && false) && <Chip style={{ width: '25%' }} label="CARREGANDO ITEMS..." color="info" />}
