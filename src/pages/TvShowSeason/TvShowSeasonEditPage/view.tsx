...
const TvShowSeasonEditPageView: React.FC<{ getTvShow: any, getSeason: any, isLoading: boolean, update: any }> =
    function ({ getTvShow, getSeason, isLoading, update }) {
        ...
        return (
            <PageCard title={`EDITAR TEMPORADA${(typeof getTvShow !== "undefined" && getTvShow !== null)
                    ...
                    <Grid item md={6} xs={12}>
                        <Card>
                            <CardActions>
                                <Grid container spacing={2}>
                                    <Grid item xs={12}>
                                        <FormControlField isDisabled={(!getSeason || isLoading)} labelValue="NOME*"
                            ...
                            <CardActions className={classes.button_end}>
                                <ButtonSuccess title="SALVAR" iconStart={ICON_OBJECT_LIST.CHECK_ICON}
                                    isDisabled={(!getSeason || isLoading)} actionClick={() => update(nameField)} />
...
export default TvShowSeasonEditPageView