...
const SignUpPageView: React.FC<{ register: any }> = function ({ register }) {
                ...
                <Grid item lg={10} xs={12}>
                    <Card>
                        <CardActions>
                            <Grid container spacing={2}>
                                ...
                                <Grid item sm={3} xs={12}>
                                    <FormControlField typeField={viewPassword ? "text" : "password"}
                        ...
                        <CardActions className={classes.button_end}>
                            <Hidden smDown>
                                <ButtonSuccess title="REGISTRAR" iconStart={ICON_OBJECT_LIST.CHECK_ICON}
                                    actionClick={() => register(nameField, birthField, cellphoneField,
                                        emailField, passwordField, confirmPasswordField)} />
                                <ButtonBlueGray title="ÁREA DE ACESSO" iconStart={ICON_OBJECT_LIST.ACCOUNT_CIRCLE_ICON}
                                    actionClick={() => navigate(URL_SIGN_IN)} />
                            </Hidden>
                            <Hidden mdUp>
                                <Grid container spacing={2} direction="row" justifyContent="center" alignItems="center">
                                    <Grid item xs={12}>
                                        <ButtonSuccess isFullWidth title="REGISTRAR" iconStart={ICON_OBJECT_LIST.CHECK_ICON}
                                            actionClick={() => register(nameField, birthField, cellphoneField, emailField,
                                                passwordField, confirmPasswordField)} />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <ButtonBlueGray isFullWidth title="ÁREA DE ACESSO"
                                            iconStart={ICON_OBJECT_LIST.ACCOUNT_CIRCLE_ICON}
                                            actionClick={() => navigate(URL_SIGN_IN)} />
                                    </Grid>
                                </Grid>
                            </Hidden>
