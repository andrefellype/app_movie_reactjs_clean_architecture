...
const UserNewView: React.FC<{ saveRegister: any }> = function ({ saveRegister }) {
                    ...
                    <Card>
                        <CardActions>
                            <Grid container spacing={2}>
                                ...
                                <Grid item md={3} xs={12}>
                                    <FormControlFieldMask valueMask="(99) 99999-9999" labelValue="CELULAR*" valueDefault={cellphoneField}
                                ...
                                <Grid item md={4} xs={12}>
                                    <FormControlFieldSelect labelValue="NÍVEL*" valueDefault={levelField} onChangeForm={(e) => setLevelField(e.target.value)} selectList={[{ label: "ADMINISTRADOR", value: "ADMIN" }]} />
                                </Grid>
                        ...
                        <CardActions className={classes.button_end}>
                            <ButtonSuccess title="SALVAR" iconStart={ICON_OBJECT_LIST.CHECK_ICON} actionClick={() => saveRegister(nameField, birthField, emailField, cellphoneField, passwordField, confirmPasswordField, levelField)} />
