...
const ForgotPasswordPageView: React.FC<{ recovery: any }> = function ({ recovery }) {
                ...
                <Grid item lg={4} md={5} sm={8} xs={12}>
                    <Card>
                        ...
                        <CardActions className={classes.button_end}>
                            <Hidden mdDown>
                                <ButtonSuccess title="ENVIAR LINK" iconStart={ICON_OBJECT_LIST.CHECK_ICON}
                                    actionClick={() => recovery(cellphoneField)} />
                            ...
                            <Hidden lgUp>
                                <Grid container spacing={2} direction="row" justifyContent="center" alignItems="center">
                                    <Grid item xs={12}>
                                        <ButtonSuccess isFullWidth title="ENVIAR LINK" iconStart={ICON_OBJECT_LIST.CHECK_ICON}
                                            actionClick={() => recovery(cellphoneField)} />
                                    </Grid>
                                    <Grid item xs={12}>
