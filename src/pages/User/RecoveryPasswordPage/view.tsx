...
const RecoveryPasswordPageView: React.FC<{ getUser: any, updatePassword: any }> = function ({ getUser, updatePassword }) {
    ...
    return (
        <PageCard title="ALTERAR A SUA SENHA" sizeMd={7} sizeSm={8} sizeXs={12}>
                    ...
                    <Card>
                        <CardActions>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12} lg={6}>
                                    <FormControlFieldMask labelValue="CELULAR" valueMask="(99) 99999-9999"
                                ...
                                <Grid item sm={6} xs={12}>
                                    <FormControlField typeField={confirmViewPassword ? "text" : "password"} labelValue="CONFIRMAÇÃO*"
                        ...
                        <CardActions className={classes.button_end}>
                            <ButtonSuccess title="SALVAR" iconStart={ICON_OBJECT_LIST.CHECK_ICON}
                                actionClick={() => updatePassword(passwordField, confirmPasswordField)} />
                        </CardActions>
                    </Card>
                </Grid>
            </Grid>
...
export default RecoveryPasswordPageView