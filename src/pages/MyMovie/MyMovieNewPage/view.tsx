...
import {
    ...
    Paper, Table, TableContainer, TableRow
} from "@mui/material"
...
const MyMovieNewPageView: React.FC<{
    ...
    function ({
        ...
        function changeSearchMovie(search: string, typeAction: "typing" | "click") {
        ...
        function dialogMovies() {
            return (<Dialog fullWidth maxWidth="xl" open={showMovie} onClose={() => setShowMovie(true)} aria-labelledby="form-dialog-title">
                <DialogContent style={{ marginLeft: 10, marginRight: 10 }}>
                    <FormControlField style={{ marginBottom: 20 }} valueDefault={searchTextMovie} labelValue="DIGITE O NOME" onChangeForm={(e) => changeSearchMovie(e.target.value, "typing")} InputProps={{
                        endAdornment: <InputAdornment position="end">
                            {searchTextMovie.length > 0 && <IconButton edge="end" onClick={() => changeSearchMovie("", "click")}><IconList icon={ICON_OBJECT_LIST.CLEAR_ICON} /></IconButton>}
...
export default MyMovieNewPageView