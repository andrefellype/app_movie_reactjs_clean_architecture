...
const MyMovieNewView: React.FC<{ movies: any, actionChangeSearchMovie: any, actionRefreshListMovie: any, saveRegister: any, removeRegister: any }> = function ({ movies, actionChangeSearchMovie, actionRefreshListMovie, saveRegister, removeRegister }) {
    ...
    function dialogMovies() {
        return (<Dialog fullWidth maxWidth="xl" open={showMovie} onClose={() => setShowMovie(true)} aria-labelledby="form-dialog-title">
            <DialogActions style={{ marginLeft: 10, marginRight: 10 }}>
                <FormControlField valueDefault={searchTextMovie} labelValue="DIGITE O NOME" onChangeForm={(e) => changeSearchMovie(e.target.value)} InputProps={{
