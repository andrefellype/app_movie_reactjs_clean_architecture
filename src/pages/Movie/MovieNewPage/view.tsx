...
import {
    ButtonGroup, Card, CardActions, Dialog, DialogActions, DialogContent, Grid, IconButton,
    InputAdornment, Paper, Table, TableBody, TableContainer
} from "@mui/material"
...
const MovieNewView: React.FC<{
    streams: any, stream: any, actionChangeSearchStream: any, actionRefreshListStream: any, actionInsertcreateInStream: any,
    actionUpdatecreateInStream: any, actionDeletecreateInStream: any, openStream: any,
    countries: any, country: any, actionChangeSearchCountry: any, actionRefreshListCountry: any,
    actionInsertcreateInCountry: any, actionUpdatecreateInCountry: any, actionDeletecreateInCountry: any, openCountry: any,
    ...
    actionRefreshListCast: any, openActor: any, actionDeletecreateInActor: any,
    directors: any, director: any, actionChangeSearchDirector: any, actionInsertRegisterDirector: any,
    actionUpdateRegisterDirector: any, actionRefreshListDirector: any, openDirector: any, actionDeleteRegisterDirector: any,
    saveRegister: any
}> = function ({
    streams, stream, actionChangeSearchStream, actionRefreshListStream, actionInsertcreateInStream,
    actionUpdatecreateInStream, actionDeletecreateInStream, openStream,
    countries, country, actionChangeSearchCountry, actionRefreshListCountry, actionInsertcreateInCountry,
    actionUpdatecreateInCountry, actionDeletecreateInCountry, openCountry,
    categories, actionRefreshListCategory, actionChangeSearchCategory,
    actors, actor, actionChangeSearchCast, actionInsertcreateInActor, actionUpdatecreateInActor, actionRefreshListCast,
    openActor, actionDeletecreateInActor, directors, director, actionChangeSearchDirector, actionRefreshListDirector,
    actionInsertRegisterDirector, actionUpdateRegisterDirector, openDirector, actionDeleteRegisterDirector,
    saveRegister }) {
        ...
        const [movieTheaterField, setMovieTheaterField] = React.useState("YES")
        ...
        function dialogRelease() {
            return (<Dialog fullWidth maxWidth="sm" open={showRelease} onClose={() =>
                setShowRelease(true)} aria-labelledby="form-dialog-title">
                <DialogContent>
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <Grid container spacing={2}>
                                <Grid item md={4} xs={12}>
                                    <FormControlFieldSelect labelValue="DIA"
                                        isDisabled={(monthRelease === 0 || yearRelease === 0)}
        ...
        function dialogEditDirector() {
            return (<Dialog fullWidth maxWidth="xs" open={idDirectorEdit.length > 0}
                onClose={() => setIdDirectorEdit(idDirectorEdit)} aria-labelledby="form-dialog-title">
                <DialogContent>
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <Grid container spacing={2}>
                                <Grid item xs={12}>
                                    <FormControlField labelValue="NOME*" valueDefault={idDirectorEditName}
                                        onChangeForm={(e) => setIdDirectorEditName(e.target.value)} />
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
        ...
        function dialogDirectors() {
            return (<Dialog fullWidth maxWidth="sm" open={showDirector} onClose={() => setShowDirector(true)}
                aria-labelledby="form-dialog-title">
                <DialogActions style={{ marginLeft: 10, marginRight: 10 }}>
                    <FormControlField valueDefault={searchTextDirector} labelValue="DIGITE O NOME"
                        onChangeForm={(e) => changeSearchDirector(e.target.value)} InputProps={{
                                                    ...
                                                    <TableCellStyle width={100} align="center">
                                                        <ButtonGroup variant="contained" aria-label="outlined primary button group">
                                                            ...
                                                            <ButtonSuccess sizeBtn='small' titleIcon={ICON_OBJECT_LIST.CHECK_ICON}
                                                                actionClick={() => changeDirectors(true, row)} />
                                                        </ButtonGroup>
                                                    </TableCellStyle>
                                                </TableRowStyle>
                                            ))}
        ...
        function dialogEditActor() {
            return (<Dialog fullWidth maxWidth="xs" open={idActorEdit.length > 0}
                onClose={() => setIdActorEdit(idActorEdit)} aria-labelledby="form-dialog-title">
                <DialogContent>
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <Grid container spacing={2}>
                                <Grid item xs={12}>
                                    <FormControlField labelValue="NOME*" valueDefault={idActorEditName}
                                        onChangeForm={(e) => setIdActorEditName(e.target.value)} />
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
        ...
        function dialogCast() {
            return (<Dialog fullWidth maxWidth="sm" open={showCast} onClose={() => setShowCast(true)}
                aria-labelledby="form-dialog-title">
                <DialogActions style={{ marginLeft: 10, marginRight: 10 }}>
                    <FormControlField valueDefault={searchTextCast} labelValue="DIGITE O NOME"
                        onChangeForm={(e) => changeSearchCast(e.target.value)} InputProps={{
                            endAdornment: <InputAdornment position="end">
                                {searchTextCast.length > 0 && <IconButton edge="end" onClick={() =>
                                    changeSearchCast("")}><IconList icon={ICON_OBJECT_LIST.CLEAR_ICON} /></IconButton>}
                                {searchTextCast.length >= 3 && <IconButton edge="end" onClick={() =>
                                    refreshListCast()}>
                                    <IconList icon={ICON_OBJECT_LIST.REFRESH_ICON} />
                                </IconButton>}
                            </InputAdornment>
                                                ...
                                                <TableRowStyle hover key={key}>
                                                    ...
                                                    <TableCellStyle width={100} align="center">
                                                        <ButtonGroup variant="contained" aria-label="outlined primary button group">
                                                            {row.enabledEdit && <ButtonSuccess sizeBtn='small'
                                                                titleIcon={ICON_OBJECT_LIST.EDIT_ICON}
                                                                actionClick={() => setIdActorEdit(row._id)} />}
                                                            {row.enabledEdit && <ButtonPink sizeBtn='small'
                                                                titleIcon={ICON_OBJECT_LIST.DELETE_ICON}
                                                                actionClick={() => setIdActorDelete(row._id)} />}
                                                            <ButtonSuccess sizeBtn='small'
        ...
        function dialogCategories() {
            return (<Dialog fullWidth maxWidth="sm" open={showCategory} onClose={() => setShowCategory(true)}
                aria-labelledby="form-dialog-title">
                <DialogActions style={{ marginLeft: 10, marginRight: 10 }}>
                    <FormControlField valueDefault={searchTextCategory} labelValue="DIGITE O NOME"
                        onChangeForm={(e) => changeSearchCategory(e.target.value)} InputProps={{
                            endAdornment: <InputAdornment position="end">
        ...
        function dialogEditCountry() {
            return (<Dialog fullWidth maxWidth="xs" open={idCountryEdit.length > 0} onClose={() =>
                setIdCountryEdit(idCountryEdit)} aria-labelledby="form-dialog-title">
                <DialogContent>
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <Grid container spacing={2}>
                                <Grid item xs={12}>
                                    <FormControlField labelValue="NOME*" valueDefault={idCountryEditName}
                                        onChangeForm={(e) => setIdCountryEditName(e.target.value)} />
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
        ...
        function dialogEditStream() {
            return (<Dialog fullWidth maxWidth="xs" open={idStreamEdit.length > 0}
                onClose={() => setIdCountryEdit(idStreamEdit)} aria-labelledby="form-dialog-title">
                <DialogContent>
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <Grid container spacing={2}>
                                <Grid item xs={12}>
                                    <FormControlField labelValue="NOME*" valueDefault={idStreamEditName}
                                        onChangeForm={(e) => setIdStreamEditName(e.target.value)} />
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
        ...
        function dialogStream() {
            return (<Dialog fullWidth maxWidth="sm" open={showStream} onClose={() =>
                setShowStream(true)} aria-labelledby="form-dialog-title">
                <DialogActions style={{ marginLeft: 10, marginRight: 10 }}>
                    <FormControlField valueDefault={searchTextStream} labelValue="DIGITE O NOME"
                        onChangeForm={(e) => changeSearchStream(e.target.value)} InputProps={{
                            endAdornment: <InputAdornment position="end">
                                {searchTextStream.length > 0 && <IconButton edge="end" onClick={() =>
                                    changeSearchStream("")}><IconList icon={ICON_OBJECT_LIST.CLEAR_ICON} /></IconButton>}
                                                ...
                                                <TableRowStyle hover key={key}>
                                                    ...
                                                    <TableCellStyle width={100} align="center">
                                                        <ButtonGroup variant="contained" aria-label="outlined primary button group">
                                                            {row.enabledEdit && <ButtonSuccess sizeBtn='small'
                                                                titleIcon={ICON_OBJECT_LIST.EDIT_ICON}
                                                                actionClick={() => setIdStreamEdit(row._id)} />}
                                                            {row.enabledEdit && <ButtonPink sizeBtn='small'
                                                                titleIcon={ICON_OBJECT_LIST.DELETE_ICON}
        ...
        return (
            <PageCard title="NOVO FILME" sizeXs={12}>
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <Card>
                            <CardActions>
                                <Grid container spacing={2}>
                                    <Grid item md={4} xs={12}>
                                        <FormControlField labelValue="TÍTULO*" valueDefault={titleField}
                                    ...
                                    <Grid item md={5} xs={12}>
                                        <FormControlField labelValue="DIRETOR" valueDefault={getShowDirectors()} InputProps={{
                                            endAdornment: <InputAdornment position="end">
                                    ...
                                    <Grid item xs={5}>
                                        <FormControlField labelValue="ELENCO" valueDefault={getShowCasts()} InputProps={{
                                            endAdornment: <InputAdornment position="end">
                                    ...
                                    <Grid item xs={2}>
                                        <FormControlFieldMask valueMask='99:99' labelValue="DURAÇÃO*"
                                            valueDefault={durationField} onChangeForm={(e) => setDurationField(e.target.value)} />
                                    </Grid>
                                    <Grid item xs={5}>
                                    ...
                                    <Grid item md={1} xs={12}>
                                        <FormControlFieldSelect labelValue="CINEMA*" valueDefault={movieTheaterField}
                                            selectList={[{ label: 'SIM', value: 'YES' }, { label: 'NÃO', value: 'NOT' }]}
                                            onChangeForm={(e) => setMovieTheaterField(e.target.value)} />
                                    </Grid>
                                    <Grid item md={5} xs={12}>
                                        <FormControlField labelValue="SINOPSE" valueDefault={resumeField} onChangeForm={(e) =>
                                            setResumeField(e.target.value)} />
                                    </Grid>
                                </Grid>
                            </CardActions>
                            <CardActions className={classes.button_end}>
                                <ButtonSuccess title="SALVAR" iconStart={ICON_OBJECT_LIST.CHECK_ICON} actionClick={() =>
                                    saveRegister(titleField, releaseField, stateDirector.directors.map(d => d._id), stateCast.casts.map(c => c._id),
                                        durationField, stateCategory.categories.map(c => c._id), stateCountry.countries.map(c => c._id),
                                        stateStream.streams.map(s => s._id), movieTheaterField, resumeField)} />
                ...
                <DialogYesOrNot showDialog={idActorDelete !== -1} onCloseDialog={() => setIdActorDelete(-1)} clickDialogNot={() => setIdActorDelete(-1)}
                    titleDialog={MSG_DELETE_REGISTER_QUESTION} clickDialogYes={() => deletecreateInActor()} />
                <DialogYesOrNot showDialog={idCountryDelete !== -1} onCloseDialog={() => setIdCountryDelete(-1)} clickDialogNot={() => setIdCountryDelete(-1)}
                    titleDialog={MSG_DELETE_REGISTER_QUESTION} clickDialogYes={() => deletecreateInCountry()} />
                <DialogYesOrNot showDialog={idStreamDelete !== -1} onCloseDialog={() => setIdStreamDelete(-1)} clickDialogNot={() => setIdStreamDelete(-1)}
                    titleDialog={MSG_DELETE_REGISTER_QUESTION} clickDialogYes={() => deletecreateInStream()} />
            </PageCard>
        )
    }

export default MovieNewView