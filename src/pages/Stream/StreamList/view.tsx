...
import { MSG_APPROVED_REVIEWED_REGISTER_QUESTION, MSG_DELETE_REGISTERS_QUESTION, MSG_DELETE_REGISTER_QUESTION, URL_STREAM_EDIT, URL_STREAM_NEW } from '../../../app/core/consts'
...
const StreamListView: React.FC<{ streams: any, showLoading: boolean, actionChangeSearchText: any, actionRefreshList: any, actionDeleteRegister: any, actionDeleteBatch: any, actionApprovedRegister: any, getListScroll: (valueScroll: number) => any[] }> =
    function ({ streams, actionChangeSearchText, actionRefreshList, actionDeleteRegister, actionDeleteBatch, actionApprovedRegister, showLoading, getListScroll }) {
        ...
        function filterListStreams() {
            return (<CardActions className={classes.flex_center}>
                ...
                <ButtonDanger isDisabled={(!streams || streams.length === 0)} titleIcon={ICON_OBJECT_LIST.DELETE_ICON} iconTitleSize="medium" actionClick={() => setIsDeleteBatch(true)} />
            </CardActions>)
        }
