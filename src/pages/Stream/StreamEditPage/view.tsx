...
const StreamEditPageView: React.FC<{ getStream: any, isLoading: boolean, update: any }> =
    function ({ getStream, isLoading, update }) {
                    ...
                    <Grid item md={4} xs={12}>
                        <Card>
                            <CardActions>
                                <Grid container spacing={2}>
                                    <Grid item xs={12}>
                                        <FormControlField isDisabled={(!getStream || isLoading)}
                            ...
                            <CardActions className={classes.button_end}>
                                <ButtonSuccess title="SALVAR" iconStart={ICON_OBJECT_LIST.CHECK_ICON}
                                    isDisabled={(!getStream || isLoading)} actionClick={() => update(nameField)} />
                                <ButtonIndigo title="VOLTAR"
                                    iconStart={ICON_OBJECT_LIST.ARROW_BACK_IOS_NEW_ICON} actionClick={() => navigate(URL_STREAMS)} />
                            </CardActions>
                        </Card>
                    </Grid>
                </Grid>
...
export default StreamEditPageView