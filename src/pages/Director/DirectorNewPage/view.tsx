...
const DirectorNewPageView: React.FC<{ saveRegister: any }> = function ({ saveRegister }) {
    ...
    return (
        <PageCard title="NOVO DIRETOR" sizeMd={4} sizeXs={12}>
...
export default DirectorNewPageView