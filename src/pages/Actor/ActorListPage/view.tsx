...
import {
    MSG_APPROVED_REVIEWED_REGISTER_QUESTION, MSG_DELETE_REGISTERS_QUESTION, MSG_DELETE_REGISTER_QUESTION, URL_ACTOR_EDIT, URL_ACTOR_NEW
...
const ActorListPageView: React.FC<{
    actors: any, showLoading: boolean, actionChangeSearchText: any, actionRefreshList: any,
    actionDeleteRegister: any, actionDeleteBatch: any, actionApprovedRegister: any, getListScroll: (valueScroll: number) => any[]
}> =
    function ({ actors, showLoading, actionChangeSearchText, actionRefreshList, actionDeleteRegister, actionDeleteBatch,
        actionApprovedRegister, getListScroll }) {
        ...
        function filterListActors() {
            return (<CardActions className={classes.flex_center}>
                ...
                <ButtonSuccess style={{ marginLeft: 10 }} titleIcon={ICON_OBJECT_LIST.ADD_ICON} iconTitleSize="medium"
                    actionClick={() => navigate(URL_ACTOR_NEW)} />
                <ButtonDanger isDisabled={(!actors || actors.length === 0)} titleIcon={ICON_OBJECT_LIST.DELETE_ICON}
                                    ...
                                    <TableRowStyle hover key={key}>
                                        ...
                                        <TableCellStyle align="center">
                                            <ButtonGroup variant="contained" aria-label="outlined primary button group">
                                                ...
                                                <ButtonIndigo sizeBtn='small' actionClick={() => navigate(`${URL_ACTOR_EDIT}/${row._id}`)}
        ...
        function dialogDeleteBatch() {
            return (<Dialog fullWidth maxWidth="sm" open={isDeleteBatch} onClose={() => setIsDeleteBatch(true)}
...
export default ActorListPageView