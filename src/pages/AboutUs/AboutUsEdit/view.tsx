...
const AboutUsEditView: React.FC<{ getAboutUs: any, saveRegister: any }> = function ({ getAboutUs, saveRegister }) {
                ...
                <Grid item md={6} sm={8} xs={12}>
                    <Card>
                        <CardActions>
                            <Grid container spacing={2}>
                                <Grid item xs={12}>
                                    <FormControlField isMultiline totalRows={8} labelValue="INFORMAÇÃO APP" valueDefault={informationAppField} isDisabled={!getAboutUs} onChangeForm={(e) => setInformationAppField(e.target.value)} />
                                </Grid>
                                <Grid item xs={12}>
                                    <FormControlField isMultiline totalRows={8} labelValue="INFORMAÇÃO WEB" valueDefault={informationWebField} isDisabled={!getAboutUs} onChangeForm={(e) => setInformationWebField(e.target.value)} />
                                </Grid>
                            </Grid>
                        </CardActions>
                        <CardActions className={classes.button_end}>
                            ...
                            <ButtonIndigo title="VOLTAR" iconStart={ICON_OBJECT_LIST.ARROW_BACK_IOS_NEW_ICON} actionClick={() => navigate(URL_ABOUT_US)} />
                        </CardActions>
                    </Card>
                </Grid>
            </Grid>
...
export default AboutUsEditView